function CanvasJSAsCSV(b,c){var a=document.getElementsByClassName("canvasjs-chart-toolbar")[0];if(b.options.exportEnabled){var d=document.createElement("div"),e=document.createTextNode("Save as CSV");d.setAttribute("style","padding: 12px 8px; background-color: white; color: black");d.appendChild(e);d.addEventListener("mouseover",function(){d.setAttribute("style","padding: 12px 8px; background-color: #2196F3; color: white")});d.addEventListener("mouseout",function(){d.setAttribute("style","padding: 12px 8px; background-color: white; color: black")});
d.addEventListener("click",function(){downloadCSV({filename:(c||"chart-data")+".csv",chart:b})});a.childNodes[1].appendChild(d)}else a=document.createElement("button"),e=b.container.getBoundingClientRect(),console.log(e),a.style.cssText="position:absolute;display: inline-block;padding: 5px 15px;cursor: pointer;text-align: center;text-decoration: none;background-color: #f4511e;border: none;border-radius: 10px;left:"+(e.right-60)+"px; top:"+e.top+"px",e=document.createElement("IMG"),e.setAttribute("src",
...
a.appendChild(e),a.addEventListener("mouseover",function(){this.style.cssText+="background-color: #d4511e;"}),a.addEventListener("mouseout",function(){this.style.cssText+="background-color: #f4511e;"}),a.addEventListener("click",function(){downloadCSV({filename:"chart-data.csv",chart:b})}),b.container.parentNode.insertBefore(a,b.container.nextSibling)}
